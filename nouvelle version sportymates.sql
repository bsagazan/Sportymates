...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 29 Mai 2016 à 00:36
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci AUTO_INCREMENT=9 ;
...
(7, 3, 'Délires', 'Décrivez ici tous vos délires les plus fous', 50, 18, 1, 1, 0, 0, 0, 0, 0);
...
(6, 2, 'Test', 12, 4, 1464470259, 'Message', 25, 24, 1);
...
('groupetest', 'Amrita', 'APP', 312, '2016-03-22 10:11:00', '', '', 7, '', 'danse.jpg'),
('alpha', 'Amrita', 'APP', 312, '2016-03-22 10:11:00', '', '', 18, '', 'danse.jpg'),
...
INSERT INTO `membres` (`id`, `pseudo`, `mail`, `motdepasse`, `nom`, `prenom`, `pays`, `codepostal`, `photodeprofil`, `Sexe`, `datenaissance`, `numtel`, `level`, `confirmkey`, `confirme`) VALUES
