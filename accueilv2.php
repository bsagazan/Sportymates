<head>
  <link rel="stylesheet" href="http://localhost/Sportymates1/style/accueilv21.css" />
</head>
 ...
 <div class="ccolonne3">
   ...
   <div id="titresection">
        <h2>Explorer nos differents sports</h2>
          ...
          <input class="buttonsport" type="submit" value="Voir tous les sports" onClick="window.location = 'rechercheclub.html'" ></code>
      </div>
    </section>
      ...
      a partner to play golf with, or any other sport: with more than</br>
       ...
       matching sport partner. Sportymates is set up for this specific reason,</br>
        namely matching sport partners in their local areas. This is why it has</br>
         ...
         <input class="buttonapropos" type="submit" value="En savoir plus" ></code>
  </div>
</div>
</div>
     ...
     <p>A deux pas des Halles, c'est en 1986 que Toni et Juliette</br>
        ...
        toute décontraction. Richement décoré de tableaux, tapis mexicains,</br>
         montures de cavaliers et palmier fantaisie, c'est un endroit qui reunit</br>
          ...
          <input class="buttonapropos" type="submit" value="Nous contacter"onClick="window.location = 'nouscontacter.html'"></code>
  </div>
  <div id="map"></div>
  <script>
      function initMap() {
