...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 06 Juin 2016 à 09:26
...
INSERT INTO `club` (`idClub`, `adresse`, `telephone`, `heureOuverture`, `heureFermeture`, `jourOuverture`, `jourFermeture`, `description`, `nomClub`, `imgClub`, `creation`) VALUES
(307, 'loin', '124578989', '20:00:00', '20:30:00', 'mardi', 'samedi', 'Ajouter une description du groupe', 'club2', 'club2.png', '2016-06-04 19:24:30'),
(306, 'tres loin', '15264585', '20:00:00', '02:02:00', 'mercredi', 'samedi', 'Ajouter une description du groupe', 'lol', 'lol.jpg', '2016-06-03 11:20:07'),
(303, 'issy les moulineaux', '0295874622', '14:00:00', '22:00:00', 'lundi', 'dimanche', 'Ajouter une description du groupe', 'foresthill', 'foresthill.jpg', NULL),
(1, 'pas trop loin de chez moi', '02154878', '09:00:00', '20:00:00', 'lundi', 'vendredi', 'Ajouter une description du groupe', 'footballteam', 'footballteam.jpg', NULL),
(305, 'rue notre dame des champs 75006 paris', '2515151511', '08:00:00', '21:00:00', 'lundi', 'jeudi', 'Ajouter une description du groupe', 'youpi', 'youpi.jpg', '2016-06-02 21:51:54');
...
('running fever', 'Amrita', 'Course', 302, '2016-05-07 12:03:00', '', '', 23, '', 'test.jpg'),
('dancing group', 'Amrita', 'Danse', 302, '2016-05-30 07:29:41', 'Toulouse', 'intermediaire', 11, '', 'danse.jpg'),
('groupe2', 'amrita', 'Athletisme', 299, '2016-06-03 15:44:14', 'paris', 'debutant', 24, 'Ajouter une description du groupe', 'groupe2.jpg'),
('test2', 'Muriel PARASSOURAMANAÏCK', 'Course', 299, '2016-05-31 17:41:14', 'paris', 'debutant', 24, 'Test', 'test2.jpg'),
('victoire', 'rere', 'Football', 299, '2016-06-01 22:51:34', 'paris', 'debutant', 24, '', 'victoire.jpg'),
('testtttt', 'sportymates', 'Badminton', 300, '2016-06-02 13:24:57', 'paris', 'debutant', 4, 'Ajouter une description du groupe', 'testtttt.jpg'),
('groupe3', 'amrita', 'Athletisme', 299, '2016-06-03 15:46:00', 'paris', 'debutant', 25, 'Ajouter une description du groupe', 'groupe3.jpg'),
('groupe31', 'sportymates', 'Athletisme', 299, '2016-06-04 19:36:39', 'paris', 'debutant', 2, 'Ajouter une description du groupe', 'groupe31.jpg');
...
(27, 'amrita', 'amrit.para@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'PARASSOURAMANAÏCK', 'Muriel', 'Londres', 75013, '27.jpg', 'Femme', NULL, NULL, '3', '84301770640884', 1, '0'),
(30, 'rere', 'muriel.parassou@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'PARASSOURAMANAÏCK', 'Muriel', 'France', 75013, '30.jpg', 'Femme', NULL, NULL, '2', '60774380846253', 1, '0'),
(39, 'zaza', 'zaza@gmail.com', '7b52009b64fd0a2a49e6d8a939753077792b0554', 'zaza', 'test1', 'France', 75000, NULL, 'Femme', NULL, NULL, '2', '95158679786791', 0, '0'),
(40, 'fdfd', 'test@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'test', 'eeee', 'France', 75013, NULL, 'Femme', NULL, NULL, '2', '05854573355879', 0, '0'),
(42, 'testy2', 'testy1@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'testy', 'testy1', 'France', 75013, NULL, 'Femme', NULL, NULL, '2', '95564418090874', 0, '0'),
(45, 'testy12', 'testtest@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'test12', 'test1212', 'France', 75013, NULL, 'Femme', NULL, NULL, '2', '80760563033618', 0, '0'),
(46, 'test521', 'test52@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'test52', 'test52', 'France', 75013, NULL, 'Femme', NULL, NULL, '2', '96073915749066', 0, '0'),
(47, 'retest', 'retest@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'PARASSOURAMANAÏCK', 'Muriel', 'France', 75013, NULL, 'Homme', NULL, NULL, '2', '61889321526374', 0, '0'),
(48, 'amrita', 'test522@gmail.com', 'e0c9035898dd52fc65c41454cec9c4d2611bfb37', 'PARASSOURAMANAÏCK', 'Muriel', 'France', 75013, NULL, 'Femme', NULL, NULL, '2', '16796560410900', 0, '0');
...
--
-- Index pour la table `noterclub`
--
ALTER TABLE `noterclub`
  ADD PRIMARY KEY (`idClub`,`pseudo`);

--
-- Index pour la table `notergroupe`
--
ALTER TABLE `notergroupe`
  ADD PRIMARY KEY (`nomGroupe`,`pseudo`);

--
-- Index pour la table `participe`
--
ALTER TABLE `participe`
  ADD PRIMARY KEY (`idEvenement`,`pseudo`);
...
--
ALTER TABLE `club`
  MODIFY `idClub` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=308;
--
...
--
ALTER TABLE `rubrique`
  MODIFY `idRubrique` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
